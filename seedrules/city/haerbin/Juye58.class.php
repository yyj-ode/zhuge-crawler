...
class Juye58 extends \city\PublicClass
{
    ...
    public function house_page()
    {
        ...
        foreach ($this->dis as $k => $v) {
            ...
            foreach ($data as $key => $value) {
                ...
                for ($i=1; $i <= 70; $i++) { 
                    $urlarr[] = $urlstr1 . $i . '/?key=%2525u5DE8%2525u4E1A%2525u5730%2525u4EA7&ClickID=1';
                }
            }
        }
        return $urlarr;
    ...
    {
        for ($i = 1; $i <= 70; $i++) {
            $house_info[] = 'http://' . $this->city_name . '.58.com/ershoufang/1/pn' . $i . '/?key=%2525u5DE8%2525u4E1A%2525u5730%2525u4EA7&ClickID=1';
        }
        if (!$house_info)
            writeLog('Five8Personal' . __FUNCTION__, ['url' => $house_info], $this->log);
        return $house_info;
