...
class DaSheng58 extends \city\PublicClass
{
    ...
    public function house_page()
    {
        ...
        foreach ($this->dis as $k => $v) {
            ...
            foreach ($data as $key => $value) {
                ...
                for ($i=1; $i <= 70; $i++) {
                    $urlarr[] = $urlstr1 . $i . '/?key=%2525u5927%2525u76DB%2525u5730%2525u4EA7&ClickID=1';
    ...
    public function house_detail($source_url)
    {
        ...
        preg_match("/大盛|dasheng/",$html,$match);
        if(empty($match)){
            return false;
        }
        $house_info = [];
    ...
    {
        for ($i = 1; $i <= 70; $i++) {
            $house_info[] = 'http://' . $this->city_name . '.58.com/ershoufang/1/pn' . $i . '/?key=%2525u5927%2525u76DB%2525u5730%2525u4EA7&ClickID=1';
        }
        if (!$house_info)
            writeLog('Five8Personal' . __FUNCTION__, ['url' => $house_info], $this->log);
        return $house_info;
