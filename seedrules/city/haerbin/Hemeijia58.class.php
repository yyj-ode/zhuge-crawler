...
class Hemeijia58 extends \city\PublicClass
{
    ...
    public function house_page()
    {
        ...
        foreach ($this->dis as $k => $v) {
            ...
            foreach ($data as $key => $value) {
                ...
                for ($i=1; $i <= 70; $i++) { 
                    $urlarr[] = $urlstr1 . $i . '/?key=%2525u548C%2525u7F8E%2525u5BB6%2525u623F%2525u5730%2525u4EA7&ClickID=1';
                }
            }
        }
        return $urlarr;
    ...
    public function house_detail($source_url)
    {
        ...
        preg_match("/和美家|hemeijia/",$html,$match);
        if(empty($match)){
            return false;
        }
        $house_info = [];
        ...
        $house_info['source_name'] = '和美家房地产58';
    ...
    {
        for ($i = 1; $i <= 70; $i++) {
            $house_info[] = 'http://' . $this->city_name . '.58.com/ershoufang/1/pn' . $i . '/?key=%2525u548C%2525u7F8E%2525u5BB6%2525u623F%2525u5730%2525u4EA7&ClickID=1';
        }
        if (!$house_info)
            writeLog('Five8Personal' . __FUNCTION__, ['url' => $house_info], $this->log);
        return $house_info;
