...
//    }
    ...
    public $PRE_URL = 'http://tj.5i5j.com/exchange/';
    private $current_url = '';
    public function house_page()
    {
        //区域
...
//                $html =  getHtml($this->current_url);
    ...
    */
    public function house_detail($source_url){
        ...
        $house_info['owner_name'] = trimall(strip_tags($connect[0][0]));
    ...
    public function house_count(){
        $PRE_URL = 'http://tj.5i5j.com/exchange/';
    ...
    public function callNewData(){
        //http://tj.5i5j.com/exchange/s5n1
        $url = 'http://tj.5i5j.com/exchange/s5n';
        $data = [];
