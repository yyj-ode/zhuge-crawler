...
/**
 * @description 上海58同城业主个人 合租房抓取规则
 * @classname 上海58同城业主个人 OK
 */
Class Five8PersonalHezu extends \city\PublicClass{
	public function house_page(){
		...
		for($page= 1;$page<=$maxPage;$page++){
            ...
            $urlarr[] = 'http://m.58.com/'.$dis[$index].'/hezu/0/pn'.$page.'?refrom=wap';
		}
        return $urlarr;
	}
	/*
	...
	*/
	public function house_list($url){
        ...
        $house_info = array();
		preg_match("/<ul\s*class=\"infoList\s*infoL\">([\x{0000}-\x{ffff}]*?)<\/ul>/u", $html, $out);
// 		dump($out[0]);die;
