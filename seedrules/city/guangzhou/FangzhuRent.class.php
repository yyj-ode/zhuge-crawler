...
//        $Parameters ["page"] = $page;
        ...
        $Parameters['post'] = ['house_way'=>1,'page'=>$page];
        $list_decode =$this->getUrlContent(  $source_url, $Parameters );
        $house_info = array();
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://gz.fangzhur.com/rent/d-".$value['id'].".html";
        }
...
//        $Parameters ["member_id"] = "-1";
        ...
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://gz.fangzhur.com/rent/d-".$value.".html";
	...
	public function house_count(){
	    	    $PRE_URL = 'http://gz.fangzhur.com/rent/';
