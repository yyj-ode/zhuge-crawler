...
/**
 * @description 广州房主儿 合租房抓取规则
 * @classname 广州房主儿(k-no area)
 */

class FangzhuHezu extends \city\PublicClass{
    Public function house_page() {
        $maxPage =  1081;
        $url = "http://gz.fangzhur.com/iosapp/highsearch3.0.php";
        $urlarr = array();
...
//        $Parameters ["page"] = $page;
        ...
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://gz.fangzhur.com/hezu/d-".$value['id'].".html";
        }
...
//       $house_info['off_type'] = $this->is_off($source_url);
        ...
        $value = $value[1];
        $url_content = "http://gz.fangzhur.com/iosapp/rent/rentdetail.php";
        // $Parameters这个是要提交的数组
//        $Parameters = array ();
//        $Parameters ["house_id"] = $value;
//        $Parameters ["member_id"] = "-1";//未登录为-1
        ...
        //出租间面积
        //var_dump($result_content['rentxiangqing'][0]);
       // $house_info['house_totalarea']= $result_content['rentxiangqing'][0]['house_totalarea'];
        ...
        //appurl
        $house_info['app_url']= "http://gz.fangzhur.com/iosapp/rent/rentdetail.php?".$getparam;
        //wap端url
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://gz.fangzhur.com/hezu/d-".$value.".html";
	...
	public function house_count(){
	    	    $PRE_URL = 'http://gz.fangzhur.com/hezu/';
