...
//        $Parameters ["page"] = $page;
        ...
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://bj.fangzhur.com/rent/d-".$value['id'].".html";
        }
...
//        $Parameters ["member_id"] = "-1";
        ...
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://bj.fangzhur.com/rent/d-".$value.".html";
	...
	public function house_count(){
	    	    $PRE_URL = 'http://bj.fangzhur.com/rent/';
...
//                }],
                "borough_name"=>['div.xiang4210:nth-child(2) > ul:nth-child(1) > li:nth-child(9) > a:nth-child(1)','text'],
                "house_price"=>['div.xiang4210:nth-child(1) > span:nth-child(1) > font:nth-child(1)','text',''],
                "house_totalarea"=>['div.xiang4210:nth-child(2) > ul:nth-child(1) > li:nth-child(2)','text'],
