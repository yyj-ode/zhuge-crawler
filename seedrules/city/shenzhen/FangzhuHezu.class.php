...
/**
 * @description 深圳房主儿 合租房抓取规则
 * @classname 深圳房主儿(k-ok no area)
 */
...
//        $Parameters ["page"] = $page;
        ...
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://sz.fangzhur.com/hezu/d-".$value['id'].".html";
        }
...
//        $house_info['off_type'] = $this->is_off($source_url);
        ...
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://sz.fangzhur.com/hezu/d-".$value.".html";
        ...
        //入住人限制
        preg_match("/(限男生|限女生|男女不限)/", $html, $sex);
    ...
    public function house_count(){
        $PRE_URL = 'http://sz.fangzhur.com/hezu/';
