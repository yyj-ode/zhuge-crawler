...
/**
 * @description 深圳快有家合租房源抓取规则
 * @classname 深圳快有家合租(k-ok)
 */
...
Class KyjHezu extends \city\PublicClass{
    ...
    Public function house_page(){
         ...
         */
        //从首页获取最大列表页
        $url = "http://sz.kuaiyoujia.com/zufangs/hezuhouse/quyu";
        $maxPage = $this->getMaxPage($url);
        $urlarr = [];
        for($page = 1; $page <= $maxPage; $page ++) {
            $urlarr[] = "http://sz.kuaiyoujia.com/zufangs/hezuhouse/quyu-i".$page;
        }
        return $urlarr;
    }
