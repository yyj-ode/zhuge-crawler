...
/**
 * @description 深圳58同城业主个人整租房抓取规则
 * @classname 深圳58同城(k-ok)
 */
Class Five8PersonalRent extends \city\PublicClass{
	...
	public function house_page(){
		...
		for($page= 1;$page<=$maxPage;$page++){
	        $url[] = 'http://m.58.com/'.$dis[$index].'/zufang/0/pn'.$page.'?refrom=pcfront';
		}
		return $url;
	}
	/*
	...
	*/
	public function house_list($url){
		...
		foreach ($ids as $k=>$v){
			$house_info[] = "http://m.58.com/sz/zufang/".$v."x.shtml";
		}
		return $house_info;
	}
	/*
...
// 		dump($phone);die;
		...
		preg_match_all("/ref=\"([\x{0000}-\x{ffff}]+?jpg)\"/u", $pics[1], $pic);
