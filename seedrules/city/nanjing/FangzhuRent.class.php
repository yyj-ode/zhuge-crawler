...
//        $Parameters ["page"] = $page;
        ...
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://nj.fangzhur.com/rent/d-".$value['id'].".html";
        }
...
//        $Parameters ["member_id"] = "-1";
        ...
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://nj.fangzhur.com/rent/d-".$value.".html";
	...
	public function house_count(){
	    	    $PRE_URL = 'http://nj.fangzhur.com/rent/';
