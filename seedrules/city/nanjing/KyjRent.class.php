...
/**
 * @description 南京快有家整租房源抓取规则
 * @classname 南京快有家整租(k-ok M-ok)
 */
...
Class KyjRent extends \city\PublicClass{
    ...
    Public function house_page(){
         ...
         */
        //从首页获取最大列表页
        $url = "http://nj.kuaiyoujia.com/zufangs/house/quyu";
        $maxPage = $this->getMaxPage($url);
        $urlarr = [];
        for($page = 1; $page <= $maxPage; $page ++) {
            $urlarr[] = "http://nj.kuaiyoujia.com/zufangs/house/quyu-i".$page;
        }
        return $urlarr;
    }
