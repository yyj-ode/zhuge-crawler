...
/**
 * @description 南京房主儿 合租房抓取规则
 * @classname 南京房主儿(k-ok)
 */
class FangzhuHezu extends \city\PublicClass{
    Public function house_page() {
        $maxPage =  1081;
        $url = "http://nj.fangzhur.com/iosapp/highsearch3.0.php";
        $urlarr = array();
...
//        $Parameters ["page"] = $page;
        ...
        foreach ( $list_decode ['xinxi'] as $value ) {
            $house_info[] = "http://nj.fangzhur.com/hezu/d-".$value['id'].".html";
        }
...
//        $house_info['off_type'] = $this->is_off($source_url);
        ...
        $value = $value[1];
        $url_content = "http://nj.fangzhur.com/iosapp/rent/rentdetail.php";
        // $Parameters这个是要提交的数组
//        $Parameters = array ();
...
//        $Parameters ["member_id"] = "-1";
       ...
       // $house_info['house_totalarea']= $result_content['rentxiangqing'][0]['house_totalarea'];
        ...
        //appurl
        $house_info['app_url']= "http://nj.fangzhur.com/iosapp/rent/rentdetail.php?".$getparam;
        //wap端url
        $house_info['wap_url']= "";
        //电脑端url
        $house_info['source_url']= "http://nj.fangzhur.com/hezu/d-".$value.".html";
	...
	public function house_count(){
	    	    $PRE_URL = 'http://nj.fangzhur.com/hezu/';
